...
public class CardDisplay : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    [Header("Textos de Habilidade")]
    public TMPro.TextMeshProUGUI textoTituloHabilidade;
    public TMPro.TextMeshProUGUI textoDescricaoHabilidade;
    ...
    { 
        ...
        // Atualiza os textos de habilidade, se os objetos existirem na carta
    if (textoTituloHabilidade != null)
    {
        textoTituloHabilidade.text = cardData.tituloHabilidade;
    }

    if (textoDescricaoHabilidade != null)
    {
        textoDescricaoHabilidade.text = cardData.descricaoHabilidade;
    }
    }
    ...
    { 
        if (GameManager.instancia == null) return; // <-- Trava de Segurança
        if (this == GameManager.instancia.painelCartaDetalhe || parentOriginal != GameManager.instancia.maoJogador) return; 
